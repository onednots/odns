...
public:
    ...
    QLabel *label;
    QLabel *label_2;
    IcebergcoinAmountField *payAmount;
    ...
    void setupUi(QFrame *SendCoinsEntry)
    {
        ...
        payAmount = new IcebergcoinAmountField(SendCoinsEntry);
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The address to send the payment to  (e.g. IcebergcoinfwYhBmGXcFP2Po1NpRUEiK8km2)", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
